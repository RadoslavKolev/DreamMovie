...
namespace DreamMovie
{
    public partial class Form_Accounts : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'moviesDataSet2.Accounts' table. You can move, or remove it, as needed.
            this.accountsTableAdapter.Fill(this.moviesDataSet2.Accounts);
        ...
        private void button_InsertClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    myConnection = new SqlConnection(lf.connection);
                    myCommand = new SqlCommand("INSERT INTO Accounts(username, fullname, email, password) VALUES (@username, @fullname, @email, @password)", myConnection);
        ...
        private void button_SaveToTxtClick(object sender, EventArgs e)
        {
            ...
            string filePath = "D:\\ТУ Варна\\Семестър 6\\Управление на софтуерни проекти\\Проект\\DreamMovie\\Справки\\Accounts.txt";
