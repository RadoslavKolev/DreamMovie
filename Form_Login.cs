...
namespace DreamMovie
{
    public partial class Form_Login : Form
    {
        ...
        public string connection = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\ТУ Варна\Семестър 6\Управление на софтуерни проекти\Проект\DreamMovie\Movies.mdf;Integrated Security=True";
